module MEM2WB_register(clk , rest , Freze , Add_Result_In , Mem_Result_In , Alu_Result_In , Rd_In , Add_Result_Out , Mem_Result_Out , Alu_Result_Out , Rd_Out );

	input clk , rest , Freze ; 
	input[15:0] Add_Result_In , Mem_Result_In , Alu_Result_In , Rd_In ;
	output[15:0]  Add_Result_Out , Mem_Result_Out , Alu_Result_Out , Rd_Out ;

	reg [15:0]  Add_Result_Out_register , Mem_Result_Out_register , Alu_Result_Out_register , Rd_Out_register ;
